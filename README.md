...
Intially, the application pulled in incorrect data: Answered and unanswered split evenly didn't match data notebook values. Fix: I traced the data lineage, found the summary was built from a stale/misaligned source (values coerced/filtered), corrected the is_answerable computation and types, rebuilt the summary and cleared the cache — the pie now reflects the true 92,749 / 49,444 split.
